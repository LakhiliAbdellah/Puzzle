...
public class PrendrePhoto extends Activity
{
    ...
    protected static final String FILENAME_DIR = "Puzzle.Game";
    ...
    {
        return getSharedPreferences(PrendrePhoto.class.getName(), Activity.MODE_PRIVATE);
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            new AlertDialog.Builder(PrendrePhoto.this)
                    .setTitle("Exit")
                    .setMessage("Que voulez-vous faire ?")
                    .setIcon(R.drawable.ic_launcher)
                    .setPositiveButton("Exit", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            PrendrePhoto.this.finishAffinity();
